...

				{
					...
					for (int i = 0; i < 13; i++)    // パネルは全13枚。
					{
...

						{
							...
							if (n現在のスクロールカウンタ != 0)
								ResolveTitleTexture(this.stバー情報[nパネル番号].ttkタイトル).t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, xAnime + 318 + (int)BoxX + TJAPlayer3.Skin.SongSelect_Title_X, y + 52 + (int)BoxY + TJAPlayer3.Skin.SongSelect_Title_Y);
							else if (n見た目の行番号 != 5)
								ResolveTitleTexture(this.stバー情報[nパネル番号].ttkタイトル).t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, xAnime + 318 + (int)BoxX + TJAPlayer3.Skin.SongSelect_Title_X, y + 52 + (int)BoxY + TJAPlayer3.Skin.SongSelect_Title_Y);
							...
							if (this.ttk選択している曲のサブタイトル != null)
							{
								...
								if (this.ttk選択している曲の曲名 != null)
								{
									...
									if(ctBarOpen.n現在の値 >= 90)
										tx選択している曲のサブタイトル.t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, 647 + TJAPlayer3.Skin.SongSelect_Title_X, 416 - (ctBarOpen.n現在の値 <= 100 ? 0 : (ctBarOpen.n現在の値 - 100)) + TJAPlayer3.Skin.SongSelect_Title_Y - 10);
									...
									ResolveTitleTexture(this.ttk選択している曲の曲名).t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, 647 + TJAPlayer3.Skin.SongSelect_Title_X, 376 - (ctBarOpen.n現在の値 <= 97 ? 0 : ((ctBarOpen.n現在の値 - 97))) + TJAPlayer3.Skin.SongSelect_Title_Y - 10);
								}
							}
							else
							{
